          ...
          <div class="col-lg-4 col-md-6">
            <div class="logo-and-social-media-area">
              <div class="footer-logo">
                <a href="#">
                  <img src="assets/image/logo/logo.png" alt="" /></a>
              </div>
              <div class="footer-content">
                <p>
                 Scriptdone  provides complete tech support development,
      ...
      <div class="container">
        <div class="footer-bottom">
          <div class="copy-write-area">
            <p>
              Copyright © 2025, Scriptdone Software
 ...
 <!-- Popper and Bootstrap JS -->
  ...
  <script>
                var url = 'https://wati-integration-prod-service.clare.ai/v2/watiWidget.js?48452';
                ...
                "brandSetting":{
                    ...
                    "welcomeText":"Namashkar! 🙏\nHow can I help you?",
                    "messageText":"Hi, I'm looking to build a custom software solution for my business. Can you guide me on where to start?",
                    "backgroundColor":"#00e785",
                    "ctaText":"Chat with us",
                    "borderRadius":"25",
                    "autoShow":false,
                    "phoneNumber":"+917303942683"
                }
                };
                s.onload = function() {
